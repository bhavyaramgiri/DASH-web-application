...
# function for generating map for zip-codes ---------------------------------------------------------------------------------
...
def gen_map_zipcode(zipcode):
    ...
    return {
        "data": [{
                ...
                "lon": list(site_lon1),
                "hoverinfo": "text",
                "hovertext": [["zipcode: {:05} <br>state: {} <br>solar energy in kwh: {:,.2f}".format(i,j,k)]
...
# function for generating map for cities ---------------------------------------------------------------------------------
def gen_map_city(city):
    ...
    return {
        "data": [{
                ...
                "lon": list(site_lon1),
                "hoverinfo": "text",
                "hovertext": [["city: {} <br>state: {} <br>solar energy in kwh: {:,.2f}".format(i,j,k)]
                                for i,j,k in zip(df_1['region_name'], df_1['state_name'],df_1['yearly_sunlight_kwh_total'])],
                "mode": "markers",
...
# function for generating map for county ---------------------------------------------------------------------------------
def gen_map_county(county):
    ...
    return {
        "data": [{
                ...
                "lon": list(site_lon1),
                "hoverinfo": "text",
                "hovertext": [["county: {} <br>state: {} <br>solar energy in kwh: {:,.2f}".format(i,j,k)]
                                for i,j,k in zip(df_1['region_name'], df_1['state_name'],df_1['yearly_sunlight_kwh_total'])],
                "mode": "markers",
...
# function for generating bar graph ---------------------------------------------------------------------------------
...
#table for carbon offset paragraph ----------------------------------------------------------------------        
        html.Div(style={'backgroundColor': "#000000"}, children=[
                html.Div(
                    [
                        html.H6(id='carbon',
...
#callback for carbon offset text------------------------------------------------------------------------------------------------
@app.callback(
...
#callback for acres of trees to sequester co2 text---------------------------------------------------------------------
@app.callback(
